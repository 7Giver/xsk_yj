<template>
	<view class="container">
			<view class="qrimg-i">
        <!-- https://cdn.swh296.com/uploads/20200428/f8a9896ae042f2a17e9c57d2009c4d78.jpg -->
      ...
      this.$http
        ...
        .then(response => {
          ...
          if (response.code === 1) {
            ...
            // let icon = response.data.store_info.log_image_text
            // let icon = 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83erww9VePvwgQceOM3FPyFt0yv1qiaagHPnxzEnLgOfcUuRCsyjvic6py9YQUINCPv9zrzcr3NicABkjw/132'
            // console.log('icon',icon)
            // this.icon = icon
            // this.icon = 'http://tmp/wxf7da6a8a73a7d424.o6zAJs88ayI__azqq73vZnb_kmZo.Qz1BAb2MaCrZcd60915a6e7c93369aacb645f5453ecf.png'
